...
>>>>>>> c5963aec2df33fa3df93d5bb877f19adfe0bab19
```
...
```
streamlit/
├── dashboard.py          Entry point — page config + st.navigation() only
...
├── data/                 Parquet files + brazil_states.geojson (copy of repo data/)
└── pages/
    ├── 1_Executive.py
    ├── 2_Products.py
    ├── 3_Geographic.py
...
See `docs/dashboard_user_guide.md` for full per-page interpretation guidance.
>>>>>>> c5963aec2df33fa3df93d5bb877f19adfe0bab19
